...
<body>
  ...
  <header id="header" class="fixed-top ">
    ...
    <a href="/" class="logo"><img src="assets/img/FMS.png" alt="" class="img-fluid"></a>
      <h1 class="logo me-auto"><a href="/">FINANCIAL GUARDIANS</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
        @auth
            <a href="{{ url('/dashboard') }}" class="btn btn-primary btn-lg btn-round">Dashboard</a>
        @else
